...
class LlamaSynEZhDataset(Dataset):
    ...
    def __init__(
        ...
        try:
            ...
            self.hf_dataset: HFDataset = load_dataset(dataset_config.dataset, name="default-83eb7a0554cdd0f4", split=split, cache_dir=dataset_config.hf_hub_dataset_cache_dir)
            if isinstance(self.hf_dataset, list):
                self.hf_dataset = concatenate_datasets(self.hf_dataset)
