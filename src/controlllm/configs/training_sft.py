...
class TrainConfigCommon:
    ...
    save_steps: int = 1000  # 1000 iterations is about 8 hours for 7B, set to 500 for 70B which is about 10 hours
    ...
    output_dir: str = '/shared/user/fine-tune/controlllm/model/llama3-10b-hf-checkpoint-sft-padding-opencoder-train-concat-no-divloss-lerp-mse-stage2/'
