...
def default_datasets():
    ...
    # return ['OpenCoderCPTAnnealing', 'OpenCoderSFTStage1', 'OpenMathInstruct2Dataset', 'LlamaSynEZhDataset', 'Llama3ChineseDataset', 'AlpacaZhDataset', 'AlpacaGPT4ZhDataset', 'RuozhibaZhDataset', 'OaastSFTZhDataset', 'StemZhDataset']
...
class TrainConfigCommon:
    ...
    # output_dir: str = '/shared/user/fine-tune/controlllm/model/checkpoint-mistral-7b-hf/' # this is mandatory
    # output_dir: str = '/shared/user/fine-tune/controlllm/model/checkpoint-llama3-8b-hf/' # this is mandatory
    # output_dir: str = '/shared/user/fine-tune/controlllm/model/checkpoint-llama3-8b-hf-sft-padding/' # this is mandatory
    # output_dir: str = '/shared/user/fine-tune/controlllm/model/checkpoint-mistral-7b-hf-sft-padding/' # this is mandatory
    output_dir: str = '/shared/user/fine-tune/controlllm/model/llama3-10b-hf-checkpoint-pretrain-packing-chinese-mixed-training-dlerp-8/'
    ...
    weight_decay: float = 1e-4  # for AdamW optimizer, takes default betas, eps, but set fixed weight decay if not None, works from 1e-2 to 1e-4
    ...
    batching_strategy: str = "packing"  # padding or packing
