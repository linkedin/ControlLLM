...
def get_preprocessed_samsum(dataset_config, tokenizer, split):
    ...
    dataset = datasets.load_dataset("samsum", name="samsum", split=split, cache_dir=dataset_config.hf_hub_dataset_cache_dir, trust_remote_code=dataset_config.trust_remote_code)
    ...
    def tokenize_add_label(sample):
        ...
        sample = {
            ...
            "labels": prompt + summary if dataset_config.pretrain else [-100] * len(prompt) + summary,
            }
