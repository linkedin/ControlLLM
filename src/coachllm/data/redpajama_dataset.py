...
def get_dataset(dataset_config, tokenizer, split):
    # note that the dataset name is different from the one in the original code, to enable loading from cache, togethercomputer/RedPajama-Data-1T->togethercomputer/redpajama-data-1t
